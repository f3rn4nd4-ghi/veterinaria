 ...
 */
package Vistas;
import controladores.MascotasController;
 ...
 * @author FERNANDA
 */
public class ListaMascotas extends javax.swing.JFrame {
     private DefaultTableModel modeloTabla;
    /**
     * Creates new form ListaMascotas
     */
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NOMBRE", "ESPECIE ", "RAZA", "COLOR", "EDAD", "PESO", "GENERO", "ESTERILIZADO", "OBSERVACIONES"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaMascotas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaMascotas().setVisible(true);
            }
        });
    }
